## copied directly from: https://github.com/huggingface/transformers/blob/e49393c3617e877f0370f7bad7c7e823808c5bfb/examples/lightning_base.py
...
class BaseTransformer(pl.LightningModule):
    ...
    def optimizer_step(self, epoch, batch_idx, optimizer, optimizer_idx, second_order_closure=None,
                       using_native_amp=None, on_tpu = False, using_lbfgs = False):
